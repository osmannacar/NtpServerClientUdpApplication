...
int main(int argc, char *argv[])
{
    ...
    NtpClient ntpClient(1234);
    ntpClient.createSocket();
    ntpClient.buildClientInfo();
    ntpClient.startNtp();
...
//      if (hostp == NULL){
//        Q_ASSERT("ERROR on gethostbyaddr");
//      }
//      hostaddrp = inet_ntoa(clientaddr.sin_addr);
//      if (hostaddrp == NULL){
//        Q_ASSERT("ERROR on inet_ntoa\n");
//      }
...
//#define PORT     1234
//#define MAXLINE 19 // lenght of date
//int main(int argc, char *argv[])
//{
//    QCoreApplication a(argc, argv);
//    int sockfd;
